...
![A command line interface showing the output of a script. The path displayed is "PS C:sersELLneDriveesktoppotify>", and the command executed is "npm run dev". The script uses nodemon to monitor changes and outputs "Server running on port 3000".](https://lh7-us.googleusercontent.com/docsz/AD_4nXcEKfZBXY4Zo0XTBoUBfEarxKRO1YjeHp6JJFqvrI2QQS5KMx9NBQypTOG5BlCBjZe7Obsv8HxLKwsKd_Nnf1YQljCl_m9lHqQOmv4JBngr0er7QS6lEIThfNvHOYbgMMm3-pDr1qvPuP3wFgd1frwJkPC0?key=Lje3gXBv7uctsh-0dlhzWg align="left")
...
!["Green banner with the text 'Spotify Playlist Generator' and a black button below that says 'Login with Spotify'."](https://lh7-us.googleusercontent.com/docsz/AD_4nXdmaJAhGT5AXcMqd6GIYNEIcMyHgOLtWWrfxyu2x6CreBX2EOphfnA46OoyhyqAMDeHAO9DxGtOtvTytSIi5g-BJ_99V_2jK7NzmEzgPUzSKQCGnZ3btPLK4--fBID0pFpUu9NejEAawitD0aEJ1Rv47gco?key=Lje3gXBv7uctsh-0dlhzWg align="left")
...
![A green interface for a Spotify Playlist Generator with fields for "Artist Name" and "Mood," and a button labeled "Generate Playlist."](https://lh7-us.googleusercontent.com/docsz/AD_4nXfC3lRngsqpA28XDnSGbyszo_X9CcAQgyUmilqybsK6hLSxkGDx-udv6vgX2GEK9JZNZDB1mxdnneLikfY5oiTra5QMQRHtAzgZa2qkSfn02kEwN9E_0fMkwNGNwF1q7ZX1h8D60qu-I4Mu4nWw7uT74XEE?key=Lje3gXBv7uctsh-0dlhzWg align="left")
...
![A generated playlist page displaying ten songs with details including titles, artists, album names, and durations. Each song has an option to listen on Spotify. The songs listed are "Story of My Life" by One Direction, "Hideaway" by Kiesza, "Meherbaan" by Shilpa Rao, Ash King, Shekhar Ravjiani, "Maiyya Mainu" by Sachet Tandon, "Teri Meri Kahaani" by Palak Muchhal, Arijit Singh, "Muskurane - Romantic" by Jeet Gannguli, Arijit Singh, "Apa Fer Milaange" by Savi Kahlon, The Masterz, "All The Small Things" by blink-182, and "Only Girl (In The World)" by Rihanna. The background is green with black song details panels.](https://lh7-us.googleusercontent.com/docsz/AD_4nXdVuZLQDOSj6h2T8gN7-9aCahQ3coOXUbYF9sSxaZTAA8havFC12dIDyu4kuCtsLPIvM_J5FdqSi4sIjNnEJOmfjN_TRcf-W047yB2bIixdwAnV0EAPens86CmUBgw2lCuoGoyRbdhqdAj09VnvCqiOBxsm?key=Lje3gXBv7uctsh-0dlhzWg align="left")
...
![A browser window with a JSON error message: { "error": "Forbidden" } displayed on localhost:3000/generate-playlist.](https://lh7-us.googleusercontent.com/docsz/AD_4nXcWcJWD79ji_M_CDjcnLD1cTHKeZnsJ6CTMn40amjvtXzuY3_0VpaIHKYmQxAPKWABx6Lc1znDW8SSD-1BA2hSME2n-RKnLsmaa9F8XJhC4dEOYo6SakD59Dht44vj7GYm6QzsH-l_dnKxqsdgxFMDP4t6w?key=Lje3gXBv7uctsh-0dlhzWg align="left")

We can also see the error in our terminal:

![Screenshot of a server log showing the status of Arcjet protection decisions. The log indicates the server is running on port 3000 and includes multiple ArcjetRuleResult entries with details such as , , , , and . Various conclusions include 'ALLOW' and 'DENY', and reasons like ArcjetShieldReason, ArcjetRateLimitReason, and ArcjetBotReason. IP details with undefined latitude are also mentioned.](https://lh7-us.googleusercontent.com/docsz/AD_4nXdB0VaW-N3d-46ypxM7UHxV27qOoQ4rLpdbrdVVvgnj1rdGt64L1FEwjiGqHj6R_XgGgjK7DcBKAei4KX497yxusASfFjWY5Aj3zUrWHrcH8m4NswRXUBDLBkieU5gKTMd1dQZpVn7m1hy53DxU1iS1Ox7N?key=Lje3gXBv7uctsh-0dlhzWg align="left")
...
![A screenshot of a web application interface showing a list of HTTP requests under the "REQUESTS" tab. The highlighted entry indicates a request made on 2024-07-02 at 01:52:48 to localhost:3000 with the path "/generate-playlist" and a status of "RATE_LIMIT". The other requests, all with an "Allow" status, include paths such as "/generate-playlist", "/", "/callback", and "/login".](https://lh7-us.googleusercontent.com/docsz/AD_4nXf5WHf8rXrMsbamA1r8zjTwBh4IoxZyRxFPEKK8ahn2PEt6nq6yvV5nEj423c1kxuyhuRetqsOB3eo50MMwsw9vcZesXbd3klcMUROrXhdcQgGFPIC9tTsYw01nooNn_AHrhx9V3_rB89Zsh3YiNQbZpl_J?key=Lje3gXBv7uctsh-0dlhzWg align="left")
...
![A screenshot of a web application interface showing request logs. One log entry is highlighted in red, indicating a request to "localhost:3000/generate-playlist" at the timestamp "2024-07-02 01:52:48.03." The request method is GET, and the IP address is 127.0.0.1. The request was denied due to "RATE_LIMIT" as the reason. Additional details of the denied request are shown on the right panel.](https://lh7-us.googleusercontent.com/docsz/AD_4nXcPOAmlzAEiFasM82I8QagkxM51IXVX3u_bzEA88Yq6x-nzo-qFHSaBSUgk7nMmLUjFgok9ztMLbVNkRwOIpoTJJy-JPWphglutU_SXpdRm7-3NDxT1gP6-CjkNCWsUDNxvTGOIrOtk9hYqKuQuyGD3a2w?key=Lje3gXBv7uctsh-0dlhzWg align="left")
